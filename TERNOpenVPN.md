...
![Shape1](ovpn_modem_setup_instructions_ML_html_1adc9aae.gif)

![](ovpn_modem_setup_instructions_ML_html_7bcd34e0.png)*Figure 1: Maxon openVPN settings.*

![Shape2](ovpn_modem_setup_instructions_ML_html_1adc9aae.gif)

![](ovpn_modem_setup_instructions_ML_html_db8592fa.png)*Figure 2: Maxon openVPN settings (continued).*

![Shape3](ovpn_modem_setup_instructions_ML_html_1adc9aae.gif)

![](ovpn_modem_setup_instructions_ML_html_21c86555.png)*Figure 3: Maxon openVPN connection confirmation.*
...
![](ovpn_modem_setup_instructions_ML_html_e48a7d67.png)*Figure 4: Maxon LAN settings.*
...
![Shape5](ovpn_modem_setup_instructions_ML_html_6be09b8f.gif)

![](ovpn_modem_setup_instructions_ML_html_bf34a289.png)*Figure 5: Maxon DHCP IP reservation.*
...
![Shape6](ovpn_modem_setup_instructions_ML_html_4b76fffb.gif)

![](ovpn_modem_setup_instructions_ML_html_fb59a2d7.png)*Figure 6: Sierra RV50X openVPN settings.*
...
![Shape7](ovpn_modem_setup_instructions_ML_html_42bf2ebc.gif)

![](ovpn_modem_setup_instructions_ML_html_93dbaff4.png)*Figure 7: Sierra RV50X LAN settings.*
...
![Shape8](ovpn_modem_setup_instructions_ML_html_184609e.gif)

![](ovpn_modem_setup_instructions_ML_html_621cb8a.png)*Figure 8: Sierra RV50X DHCP IP reservation.*
...
![Shape9](ovpn_modem_setup_instructions_ML_html_72bff12a.gif)

![](ovpn_modem_setup_instructions_ML_html_5dcdc6e1.jpg)*Figure 9: Logger IP setup.*
...
![Shape10](ovpn_modem_setup_instructions_ML_html_85f11aaa.gif)

![](ovpn_modem_setup_instructions_ML_html_13c33a20.jpg)*Figure 10: Logger Pakbus/TCP setup.*

5)  Configure remote PC and communications software

Finally, in Loggernet’s ‘Setup’ utility, configure the IP and port numbers for the logger (Figure 11).

![Shape11](ovpn_modem_setup_instructions_ML_html_1a45504f.gif)

![](ovpn_modem_setup_instructions_ML_html_96095c48.jpg)*Figure 11: Loggernet Setup configuration.*

...
* other non-flux systems (associated loggers like Cosmoz system, surface temperature, radiation, power system controll interfaces, managed routers, network-enabled relays, WiFi-extenders, ...): 192.168.x.130 or higher where possible.
